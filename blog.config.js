...
const BLOG = {
  ...
  // 网站图片
  IMG_LAZY_LOAD_PLACEHOLDER: process.env.NEXT_PUBLIC_IMG_LAZY_LOAD_PLACEHOLDER || 'https://avatars.githubusercontent.com/u/146637870?v=4', // 懒加载占位图片地址，支持base64或url
