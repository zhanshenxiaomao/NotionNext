...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xiaomao Blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiaomao.cloudns.org', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      cover:
            'https://p2.music.126.net/rBMyEisZoTWWCPgmgj7wPw==/109951163571130734.jpg'
    },
    {
      name: '王都グランセル',
      artist: 'Falcom Sound Team jdk',
      url: 'https://p2.music.126.net/rBMyEisZoTWWCPgmgj7wPw==/109951163571130734.jpg?imageView&thumbnail=360y360&quality=75&tostatic=0',
      cover:
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9157239091', // 对应歌单的 id
